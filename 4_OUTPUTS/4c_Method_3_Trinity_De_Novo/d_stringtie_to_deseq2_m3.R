...
STRINGTIE_M3_ROOT <- file.path(BASE_DIR, "4c_Method_3_Trinity_De_Novo", "5_stringtie_WD", "a_Method_3_RAW_RESULTs")

# Output directory for DESeq2 input files
DESEQ2_OUTPUT_DIR <- file.path(BASE_DIR, "4c_Method_3_Trinity_De_Novo", "DESeq2_input")
