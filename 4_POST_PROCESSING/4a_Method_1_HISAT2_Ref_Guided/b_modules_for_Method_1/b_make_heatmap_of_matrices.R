#!/usr/bin/env Rscript
# Basic Heatmap for Method 1 (HISAT2 Ref-Guided)
...
output_dir <- file.path("..", "7_Heatmap_Outputs", "I_Basic_Heatmap")
dir.create(out_dir, showWarnings=FALSE, recursive=TRUE)

group_name <- if (!is.null(GENE_GROUP_FILE)) tools::file_path_sans_ext(basename(GENE_GROUP_FILE)) else "all_genes"
out_file <- file.path(out_dir, paste0(group_name, "_", FASTA_TAG, "_heatmap.png"))
